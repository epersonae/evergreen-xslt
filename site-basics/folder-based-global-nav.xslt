    ...
    <xsl:template match="system-index-block/system-page[@current='true']">
        ...
        <nav class="top-nav" role="navigation">
            <ul class="top-nav-list">
                ...
                <li><a class="top-nav-link" href="site://Admissions/admissions/index">Admissions</a></li>
    ...
    <xsl:template match="system-folder">
        ...
        <nav class="top-nav" role="navigation">
            <ul class="top-nav-list">
                ...
                <li class="{$admissions}"><a class="top-nav-link" href="site://Admissions/admissions/index">Admissions</a></li>
